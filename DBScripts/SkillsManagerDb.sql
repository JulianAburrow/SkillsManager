...
IF EXISTS (SELECT * FROM sys.databases WHERE NAME = 'SkillsManager')
	ALTER DATABASE [SkillsManager] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE
GO
IF EXISTS (SELECT * FROM sys.databases WHERE NAME = 'SkillsManager')
	DROP DATABASE SkillsManager

GO

CREATE DATABASE SkillsManager
GO
